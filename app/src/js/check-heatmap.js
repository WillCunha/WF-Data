...
window.onload = function () {
    ...
    if (idUser) {
        ...
        Wait.style.backgroundColor = "#0000009c";
        Wait.style.position = "absolute";
        Wait.style.zIndex = "9999";
        Wait.style.display = "flex";
        Wait.style.alignContent = "center";
        Wait.style.alignItems = "center";


        Wait.innerHTML = "<p style='color: #fff; font-size: 16px; font-weight: 800; width: 100%; text-align: center'>Gerando mapa de calor... Por favor, aguarde!</p>"
        ...
        async function carregaDados() {
            ...
            if (carrega == true) {
                ...
                const response = await fetch('./wp-content/uploads/wfdata/heatmap-' + idUser + '.json');
                ...
                data.forEach(function (data, index) {
                    ...
                    heatmap.addData({ x: data.pageX, y: data.pageY, value: data.value });
        ...
        function createMessage() {
            ...
            txt.classList.add('carregandoTxt')
            txt.innerHTML = 'Carregando mapa...'
...
//         lastX = ev.pageX;
//         lastY = ev.pageY;
//         heatmap.addData({ x: lastX, y: lastY, value: 20 });
//         console.log("{'pageX' : '" + lastX + "', 'pageY ': '" + lastY, "'value' : '" + 20 + "'}");
//     };
